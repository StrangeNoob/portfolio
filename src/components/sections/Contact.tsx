        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="terminal-window">
              ...
              <nav className="terminal-body text-sm space-y-2" aria-label="Social media links">
              ...
              <div className="terminal-body">
                {isSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                    ...
                    {error && (
                      <div
                        className="text-xs text-red-500 bg-red-500/10 border border-red-500/30 rounded p-3"
                        role="alert"
                      >
